 ...
 * @method ClientContact setId()          Sets the current record's "id" value
 * @method ClientContact setClientId()    Sets the current record's "client_id" value
 * @method ClientContact setFirstName()   Sets the current record's "first_name" value
 * @method ClientContact setLastName()    Sets the current record's "last_name" value
 * @method ClientContact setPosition()    Sets the current record's "position" value
 * @method ClientContact setPhone()       Sets the current record's "phone" value
 * @method ClientContact setMovil()       Sets the current record's "movil" value
 * @method ClientContact setEmail()       Sets the current record's "email" value
 * @method ClientContact setAddress()     Sets the current record's "address" value
 * @method ClientContact setAddress2()    Sets the current record's "address_2" value
 * @method ClientContact setLocalityId()  Sets the current record's "locality_id" value
 * @method ClientContact setClient()      Sets the current record's "Client" value
 * 
 * @package    limbo
 * @subpackage model
